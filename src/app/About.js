        ...
        <Container className={'mb-32'}>
            <Box>
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <h5 className={'text-xl mt-3'}>Software Developer intern after 12th 🤙</h5>
                </div>
                <div className={'mt-12'}>
                    <p>
                        It all started with Python, and then I delved into the exciting realms of web development, and
