...
export default function NewProjectPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('/api/dashboard/projects', { ...project, slug });
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder={generateSlug(project.title)}
                                    className="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    {project.content?.map((section, index) => (
                                        ...
                                        >
                                            <div className="flex justify-between items-center mb-2">
                                                <span className="text-sm font-medium">Section: {section.id}</span>
                                                <button
                                                    type="button"
                                            ...
                                            <input
                                                ...
                                                className="mb-2 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                            />
                                            <RichTextEditor
